...
import com.example.aalizade.mbazar_base_app.adapters.pager_adapters.CustomerEditInfoViewPagerAdapter;
...
public class EditCustomerPersonalInfoActivity extends AppCompatActivity {
    protected void attachBaseContext(Context newBase) {
        super.attachBaseContext(CalligraphyContextWrapper.wrap(newBase));
    }
    NonSwipeableViewPager viewPager;
    CustomerEditInfoViewPagerAdapter adapter;
    ...
    public void RegisterFindByUsername(UserRetrofitAPIInterface userRetrofitAPIInterface) {  //دریافت اطلاعات شخصی
        ...
        ProgressBarShower.StartMyProgressBar(EditCustomerPersonalInfoActivity.this,progressWrapper);
        call.enqueue(new CallbackWithRetry<FullUserFrontModel>(call,EditCustomerPersonalInfoActivity.this,progressWrapper) {
            @Override
            public void onResponse(Call<FullUserFrontModel> call, Response<FullUserFrontModel> response) {
                ProgressBarShower.StopMyProgressBar(EditCustomerPersonalInfoActivity.this,progressWrapper);
...
//
        ...
        adapter = new CustomerEditInfoViewPagerAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
