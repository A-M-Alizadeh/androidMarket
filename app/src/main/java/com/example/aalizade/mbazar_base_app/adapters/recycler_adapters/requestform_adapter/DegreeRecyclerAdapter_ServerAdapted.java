...
public class DegreeRecyclerAdapter_ServerAdapted extends RecyclerView.Adapter<DegreeRecyclerAdapter_ServerAdapted.NewsViewHolder> {

    private Context context;
    private List<UserEducationModel> degrees;

    public DegreeRecyclerAdapter_ServerAdapted(Context context, List<UserEducationModel> degrees){
        this.context = context;
        this.degrees = degrees;
    }
    @Override
    public DegreeRecyclerAdapter_ServerAdapted.NewsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.degree_list_item,parent,false);
        return new DegreeRecyclerAdapter_ServerAdapted.NewsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DegreeRecyclerAdapter_ServerAdapted.NewsViewHolder holder, final int position) {
