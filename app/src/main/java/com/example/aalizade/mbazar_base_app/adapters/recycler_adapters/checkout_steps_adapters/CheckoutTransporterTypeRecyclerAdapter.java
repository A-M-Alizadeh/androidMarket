...
public class CheckoutTransporterTypeRecyclerAdapter extends RecyclerView.Adapter<CheckoutTransporterTypeRecyclerAdapter.NewsViewHolder> {
    private Context context;
    List<CustomCategorizeTransportingItems> categorizedList;
    LinearLayout linearLayout;


    public CheckoutTransporterTypeRecyclerAdapter(Context context, List<CustomCategorizeTransportingItems> categorizedList,LinearLayout linearLayout) {
    ...
    @Override
    public CheckoutTransporterTypeRecyclerAdapter.NewsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.a_temp_checkout_transport_item, parent, false);
        return new CheckoutTransporterTypeRecyclerAdapter.NewsViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final CheckoutTransporterTypeRecyclerAdapter.NewsViewHolder holder, final int position) {
    ...
    private void SetRecyclerAdapter(RecyclerView recyclerView,int position) {
        CheckoutTransportTypesItemsAdapter newsAdapter = new CheckoutTransportTypesItemsAdapter(context , categorizedList.get(position).getCarriedItems(),linearLayout);
