...
public interface GiftAPIInterface {
    ...
    @POST("frontPanel/userGiftRequest/create")
    Call<ResponseBody> submitUserGiftRequest(@Body UserGiftRequestModel userGiftRequestModel);

    @POST("frontPanel/taxSetting/submaster/findByUserCreditType")
    Call<HashMap<String,String>> getUserGiftTaxType(@Body HashMap<String, String> taxType);
}
